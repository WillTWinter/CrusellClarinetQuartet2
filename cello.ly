cello_i = \relative c {
  ...
  r4 bes'( f d) | ees-. f-. g2\fz | aes4-. bes-. c2~\fz | c4 c2-> c4~-> | c a(\< bes c) | bes2\f r | r4 r r2 |
  \repeat unfold 2 {bes,4( bes') bes bes} | ees,,4 ees'2\fz( f4 | ges d ees bes) | ces1(\< | bes4)\! r r2 |
  r4 ees4( g) r r g( bes) r r aes( f) r r bes,( bes') r r ees,(\pp c) r r aes( aes') r r bes( bes,) r r ees,( ees') r |
  
  % REPEAT MARK
  
  aes4\f r ees r | aes, r r2 | r4 aes'-.(\p aes-.) r r aes-.( aes-.) r r g-.( g-.) r r aes-.( aes-.) r | R1 |
  r2 r4 c,\f | des2.( d4) ees-. ees,-. r\fermata r | 
  
  R1 | r4 f'4\p bes bes,\fz | ees2.( g4) | aes aes, aes' r | r f(\p bes,) r | r ees( aes,) f'( | bes) ees,( aes) c(
  des d ees e) | f r r2 | R1*3 |
  
  c,,4.\ff e8 g4-. c-. | e g2-> \appoggiatura c,16 bes8 aes16 bes | aes4. aes8 c4-. f-. | 
  aes-. c2-> \appoggiatura aes,16 ges8( f16 ges) | f4.\p f8 aes4( des) | f( aes des, f) | bes,-. des( ees g) |
  aes,-. c( des f) |
  ...
  r4 aes'(^\arco f d| b) r b r | c r f r | g\f g g r | R1 | g4 g g g | g, g g g | c, c'2\fz\( d4 | ees b c g | aes1\)\< |
  g4\! r r2 | r4 ees(\p ees') r | r f,( f') r | r g( g,) r | r aes( aes') r | r f,( f') r | r f(\< ees d) | c\f r g' r |
  c,1~\p c~ c~ c c,~\pp c | \repeat unfold 2 {c'8(b c g b ais b g)} | c8(^\smorz b c g b ais b g) |
  c( b c fis, g fis g ees) | c2 r |  
}
...
cello_ii = \relative c {
  ...
  r4 | c4\p c' r | d, d' r | r b,(\> g | c\pp ees) r | r b'(\> g | c\p ees) e(\sf | f\p aes) d,(\sf | ees\p g) c,(\sf |
  d\p b c) | f,(\tdecresc fis g) | c,( d d,) | g g'
  ...
  R2. | c,4\p c' r | d, d' r | r b(\> g | c\pp ees) r | r d(\> bes ees g\p) g,(-> | aes c) g(-> | aes c) g(-> |
  ...
  % REPEAT
  r4 | bes4\f bes2~-> | bes4 bes2~-> | bes4 bes bes | \triplet{bes8 d f bes c bes aes g f} | ees4 r ees\p |f2 r4 |
  r d d | ees2 r4 | g,2.( | aes2\< a4 | bes2.)\p | ees,4 r
}

cello_iii = \relative c {
  \clef bass 
  \key c \minor
  
  r8 | ees2.~\p | ees8 g bes ees,4 r8 | ees2.~ | ees8 g bes ees,4 r8 | 
  aes,4( c8 ees4) r8 | aes,4( c8 ees) r d\tcresc | ees8( f bes, c g aes | bes) r bes( ees4) r8 |
  r r bes( aes'4) aes8 | g( f ees) d r bes(\fz | ees) r c\p( f) r f,( bes) d f \repeat unfold 7 {bes4.~} | 
  bes8 bes bes bes4 r8 | ees,2.~\p | ees8 g bes ees,4 r8 | ees2.~ | ees8 g bes ees,4 r8 |
  aes,4( c8 ees4) r8 | aes,4( c8 ees) r d(\tcresc | ees f bes, c g aes) | bes r bes\p ees4 r8 |
  
  % REPEAT
  bes8\f r bes bes r bes | f(g a bes4) r8 | ees,8 ees' ees c( d ees) | f4.( f,4) r8 |
  fis'8-.\p r fis-.( g)-. r fis-. | g4\<( a8 bes4 b8) | c4-.\f r8 c,4.(\p | f,8) a c f4 r8 |
  
  %REPEAT
  des8(-.\f des-. des-. des-. des-. des)-. | c(-. c-. c)-. des4( c8) | bes4 r8 ges'4.(-> | f4.~) f8 r4 |
  bes,8\p r bes bes r bes | a r a bes r r | ees r r ees4( c8) | f16( f, bes d f\tcresc e) f( g f ees d c) |
  bes(\f f d f bes a) bes( f' c f d f)| c( f bes, f' a, f') bes,4 r8 | R2. |
  r4. ees4.(\p | f2.~\< | f8)\f r r r4. | f8 f f f, f f |bes bes'-.(\> bes-. bes-. bes-. bes-.) |
  bes2.~\p bes~ bes~ | bes8 bes,-.(bes-. bes-. bes-. bes-.) | bes2.~ bes | ces(\fz\> | bes8)\! bes bes bes4 r8 |
...
cello_iv = \relative c {
  ...
  r8 | c'8-.\p r c-. r | c4-. r | r8 b( c) fis,( | g) g, g' r | c r b r | c g aes ees | f f g g | c,4 r |
  r8 g' g, r | r c' c, r | r g c ees | g g, g' r | R2 | r4 r8 ees | f f g g | c,4 r |
  
  r8 g16\f a b8 g | r c16( b) c8 c, | r16 aes''-. g-. f-. ees-. g-. ees-. c-. | g8 g' r4 |
  c4(\fz b8 bes) | a( aes g c) | f, f g g, | c c' c,
  
  % REPEAT
  r8 | c4\p r8 g' | c g c r | g r c r | g g, g'(a16 b) | c4( b) | c8 g aes ees | f4( g8 g,) c4 r8
  
  % REPEAT
  r8 | g'2~ g2~ g2~ | g8 g, g' r| R2 | r4 r8 ees f4( g8) g, |
  c4 r8  % First time bar
  c8 r r g'16-. \ff g-. |  % Second time bar
  ...
  ees8 ees, ees' ees \repeat unfold 2 { ees16( f ees f)} | d8 r ees r | f f f, f | bes4 r | R2*5 |
  
  ees4^\pizz r ees r bes r ees r bes r ees r | aes,4.(^\arco c8) | ees4 r8 ees, | aes4.( c8) |
  ees16 g bes ees des ees des ees | c ees c ees ces\< ees ces ees | bes ees bes ees e, ees' a, ees' | 
  bes8\f bes bes, bes | ees4 r | r8 g,(\fz a b | c d ees) r | r8 g,( a b | c d ees) r |
  r8 f,-. f'( g | aes a bes c) | d bes,(\fz c d | ees f g ees) | aes c,(\fz d e | f g aes bes) |
  aes2~ aes~aes~aes~ aes4 r | R2 | r8 aes8(-.\fz\> aes-. aes-. | aes-. aes-. aes-. aes)-. |
  g2~\pp g~ g~ g <g, g'>2~ <g g'>~ <g g'>4 r | R2 |
  r8 g'(\p b) b( | d4) r | r8 g,( b) b( | d4) r | r8 d,(\tcresc f aes) | b4.\fermata r8 |
  
  % PAUSES
  c8\p r c r | c4 r | r8 b( c) fis,( | g) g, g' r | c r b r | c g aes ees | f f g g | c,4 r |
  r8 g' g, r | r c' c, r | r g c ees | g g, g' r | R2 | r4 r8 ees | f f g g | 
